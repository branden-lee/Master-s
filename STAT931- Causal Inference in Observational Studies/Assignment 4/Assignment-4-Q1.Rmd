...
for(i in 1:k) {
  ...
  # provided estimated propensity scores using 1-1 matching with replacement, no
  # ties and 0.2 calipers.
...
\begin{center}
\captionof{table}{1-1 Matching with Replacement and Calipers}
